package com.kingking.maker.meta;
...
import com.kingking.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "kingking");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.kingking");
